...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(window).load(function() {
            console.log("Work just now");
            var tempstr =  
            '<div class="col-md-4 col-sm-6 col-xs-12">' +
            '<div class="item">' +
            '<a href="{{image}}" id="insta" class="portfolio-popup" title="Project Title">' +
            '<img src="{{image}}" alt="">' +
            '</a>' +
            '</div>' +
            '</div>'
            var feed = new Instafeed({
                get: 'user',
                userId: '4786576',
                clientId: 'e172ee18d78144df872d5c3bb0afc4a4',
                template: tempstr,
                accessToken: '4786576.e172ee1.59599af569f0494ba0a3d48ddf921668',
		 ...
		 */ 
         ...
         $('#my-address').gMap({
            ...
            address: "1206B Reiserstown Road, Pikesville, Maryland",  
            /* You can change display address text from here */
            html: "<b>Address</b>: <br> 1206B Reiserstown Road Pikesville, Maryland", 
            popup: true
            }
            ]
            });
